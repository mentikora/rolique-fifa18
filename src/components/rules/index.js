  ...
  <div className="rules-wrapper">
    ...
    <ul>
      <li>
        ...
        <ul>
          <li>
            A Team or Player who plays 'home' is responsible for starting a match. They also making first pick
          </li>
          <li>
      ...
      <li>
        ...
        <ul>
          <li>
            Team or Player are only allowed to pause the game when the ball is not in play, meaning it has left the fiplayerd of play or a foul has been committed and it’s a dead ball situation, or if the Team/Player holds possession of their ball in their half of the fiplayerd.
          </li>
        </ul>
      </li>
      <li>
